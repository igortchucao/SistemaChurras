...
namespace Domain
{
    public static partial class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDomainDependencies(this IServiceCollection services)
            => services
                .AddSingleton(new Person { Id = "e5c7c990-7d75-4445-b5a2-700df354a6a0" })
        ...
        public static IServiceCollection AddEventStoreDependencies(this IServiceCollection services)
        {
            ...
            var invitesStore = new EventStore<Invite>(client, DATABASE, "Invites");
            invitesStore.Initialize().GetAwaiter().GetResult();
            ...
            client.GetDatabase(DATABASE)
                ...
                .UpsertItemAsync(new Lookups { 
                    ...
                    ModeratorIds = Data.People.Where(p => p.IsCoOwner)
            ...
            try
            {
                ...
                {
                    peopleStore.WriteToStream(
                            person.Id, 
                            new[] { 
                                new EventData(person.Id, 
                                new PersonHasBeenCreated(person.Id, 
                                    person.Name, 
                                    person.IsCoOwner), 
                                null, 0, DateTime.Now.ToString()) })
                        .GetAwaiter()
                        .GetResult();
                }
            }
            ...
            services.AddSingleton<IEventStore<Invite>>(invitesStore);
        ...
        public static IServiceCollection AddRepositoriesDependencies(this IServiceCollection services)
            => services.AddTransient<IBbqRepository, BbqRepository>()
                       ...
                       .AddTransient<IInviteRepository, InviteRepository>();
